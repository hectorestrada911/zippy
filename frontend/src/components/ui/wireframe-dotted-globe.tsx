...
export default function RotatingEarth({
  ...
  useEffect(() => {
    ...
    const generateDotsInPolygon = (feature: GeoJSON.Feature, dotSpacing = 16) => {
      ...
      const geometry = feature.geometry;
      if (!geometry || (geometry.type !== "Polygon" && geometry.type !== "MultiPolygon")) return dots;
    ...
    return (
      ...
      >
        <div className="text-center">
          <p className="mb-2 font-semibold text-[var(--error)]">Error loading Earth visualization</p>
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      />
      <div
        className="absolute bottom-4 left-4 rounded-md px-2 py-1 text-xs text-[var(--muted-soft)]"

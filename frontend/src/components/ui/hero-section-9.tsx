        ...
        >
          <div className="m-auto max-w-5xl px-6">
            <div className="flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
              ...
              <div className="mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-input bg-background p-6 shadow-2xl shadow-zinc-300/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:rounded-none lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent group-data-[state=active]:block lg:group-data-[state=active]:flex">
            ...
            <div className="[perspective:1200px] [mask-image:linear-gradient(to_right,black_50%,transparent_100%)] -mr-16 pl-16 lg:-mr-56 lg:pl-56">
              <div className="[transform:rotateX(20deg)]">
                <div className="lg:h-[44rem] relative skew-x-[.36rad]">
                  <img
                    className="rounded-[var(--radius)] z-[2] relative border dark:hidden"
                  ...
                  />
                  <img
                    className="rounded-[var(--radius)] z-[2] relative hidden border dark:block"
                    src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=2880&q=80"
...
export const HeroSection9 = HeroSection;
